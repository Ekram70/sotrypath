const cardData = [
  {
    ...
    description: `You are a young explorer named Elara, eager to prove your bravery. The legends of the Enchanted Forest have intrigued you since childhood—stories of mystical creatures, hidden treasures, and a powerful artifact called the Heart of the Forest, said to grant its possessor great wisdom and power. One day, you decide it's time to see if the tales are true. Armed with your wits and a trusty map handed down from your ancestors, you step into the forest, feeling the cool, mossy earth under your feet and the dense canopy above.
  ...
  },
  {
    ...
    description: `You are Selene, a renowned treasure hunter with a reputation for finding the impossible. One day, you receive an intriguing letter from a mysterious client. The letter contains a simple message: "Find the Amulet of Shadows hidden in the old castle ruins on Raven's Peak, and you shall be richly rewarded." Intrigued by the prospect of both wealth and adventure, you accept the challenge.
